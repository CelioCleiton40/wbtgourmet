...
export const menu: MenuSection[] = [
  ...
  sec('file-mignon', { title: 'Pratos com Filé Mignon', emoji: '🥩' }, [
    ...
    { id: 'fm-trinchado',           name: 'Filé Mignon Trinchado com Fritas',        price: 55, description: 'Molho rústico' },
    { id: 'fm-parmegiana-individual', name: 'Filé à Parmegiana Individual',          price: 45, description: 'Espaguete ao molho de tomate caseiro, fritas ou purê' },
    { id: 'fm-parmegiana-duplo',    name: 'Filé à Parmegiana Duplo',                 price: 80, description: 'Espaguete ao molho de tomate caseiro, fritas ou purê' },
  ]),
  ...
  sec('sanduiches', { title: 'Sanduíches', emoji: '🍔' }, [
    ...
    { id: 'sd-lob-burg',     name: 'Lob Burg',      price: 17, description: 'Hambúrguer, queijo, salada e molho' },
    { id: 'sd-drop-chicken', name: 'Drop Chicken',  price: 20, description: 'Frango, queijo, salada e molho' },
    { id: 'sd-toss-bauru',   name: 'Toss Bauru',    price: 14, description: 'Queijo, presunto, ovo, salada e molho' },
    { id: 'sd-misto-point',  name: 'Misto Point',   price: 12, description: 'Queijo e presunto' },
    { id: 'sd-match-hotdog', name: 'Match Hot Dog', price: 22, description: 'Salsicha, carne moída e batata palha' },
  ]),
  ...
  sec('tapiocas', { title: 'Tapiocas Recheadas', emoji: '🫓' }, [
    ...
    { id: 'tp-frango',       name: 'Tapioca de Frango',     price: 15, description: 'Frango e creme de queijo' },
    { id: 'tp-mista',        name: 'Tapioca Mista',         price: 12, description: 'Queijo e presunto' },
    { id: 'tp-romeu-julieta',name: 'Tapioca Romeu e Julieta',price: 15, description: 'Doce de goiaba e queijo' },
  ]),

  sec('petiscos', { title: 'Petiscos', emoji: '🍟' }, [
    { id: 'pt-batata-frita',      name: 'Batata Frita',              price: 20, image: '/images/menu/batata-frita.jpg' },
    { id: 'pt-calabresa-fritas',  name: 'Calabresa com Fritas',      price: 35 },
    { id: 'pt-queijo-empanado',   name: 'Queijo Empanado',           price: 25 },
    { id: 'pt-carne-sol-macaxeira', name: 'Carne de Sol com Macaxeira', price: 50 },
  ]),

  sec('espetinhos', { title: 'Espetinhos', emoji: '🍢', subtitle: 'Quarta a sexta · servidos com arroz de leite, farofa e vinagrete' }, [
    { id: 'esp-padrao',  name: 'Espetinho Padrão',  price: 13, description: 'Carne, frango, queijo, calabresa, porco ou coração de frango', availability: QUA_QUI_SEX },
    { id: 'esp-premium', name: 'Espetinho Premium', price: 15, description: 'Carne c/ bacon, frango c/ bacon, asinha ou cafta',            availability: QUA_QUI_SEX },
  ]),

  sec('salgados', { title: 'Salgados Variados', emoji: '🥟' }, [
    { id: 'sg-mini-salgados', name: 'Mini Salgados (15 unid.)', price: 18 },
    { id: 'sg-mini-churros',  name: 'Mini Churros (10 unid.)',  price: 18 },
  ]),
  ...
  sec('sabores-regionais', { title: 'Sabores Regionais', emoji: '🌽', subtitle: 'Cuscuz do nordeste do jeito certo' }, [
    { id: 'cz-creme-queijo', name: 'Cuscuz Recheado com Creme de Queijo', price: 20 },
    { id: 'cz-carne-sol',    name: 'Cuscuz Carne de Sol',                 price: 17 },
    { id: 'cz-frango',       name: 'Cuscuz Frango',                       price: 15 },
    { id: 'cz-calabresa',    name: 'Cuscuz Calabresa',                    price: 15 },
    { id: 'cz-ovo',          name: 'Cuscuz Ovo',                          price: 12 },
  ]),

  sec('crepioca', { title: 'Crepioca', emoji: '🥞' }, [
    { id: 'cr-carne-sol', name: 'Crepioca Carne de Sol', price: 20 },
    { id: 'cr-frango',    name: 'Crepioca Frango',       price: 15 },
    { id: 'cr-mista',     name: 'Crepioca Mista',        price: 10 },
  ]),

  sec('panquecas', { title: 'Panquecas', emoji: '🫔', subtitle: 'Servidas com arroz solto, salada e batata palha' }, [
    { id: 'pq-carne-sol', name: 'Panqueca de Carne de Sol', price: 25 },
    { id: 'pq-frango',    name: 'Panqueca de Frango',       price: 20 },
  ]),
