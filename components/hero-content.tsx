...
const WHATSAPP_NUMBER = '5584988909408';
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="inline-flex items-center gap-2.5 rounded-full border border-g-green/30 bg-white/85 px-5 py-2 backdrop-blur-md shadow-sm"
      >
        {/* Ponto pulsante */}
        ...
        <span className="font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-g-green-dk">
      ...
      <motion.h1
        ...
        className="mt-7 font-display text-[clamp(44px,10vw,96px)] leading-[1.0] tracking-tight text-g-cream drop-shadow-sm"
      >
        Gastronomia que
        <br />
      ...
      <motion.p
        ...
        className="mt-6 max-w-xl text-base sm:text-lg leading-relaxed text-g-muted font-medium"
      >
        Filé mignon, camarão, petiscos e açaí preparados com cuidado,{' '}
        <em className="text-g-cream font-semibold not-italic">entregues direto na sua mesa</em> em Mossoró.
      </motion.p>
      ...
      >
        <Link href="#cardapio" id="hero-cta-cardapio">
          <Button
            variant="primary"
            size="lg"
            className="gap-2.5 animate-pulse-green shadow-md"
          >
      ...
      {/* Trust badges — transmitem confiança */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.56 }}
        className="mt-10 flex flex-wrap items-center justify-center gap-6 rounded-2xl border border-g-line bg-white/80 px-6 py-3.5 text-xs text-g-muted backdrop-blur-md shadow-sm"
      >
